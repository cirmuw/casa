...
class FocalLoss(nn.Module):
    ...
    def forward(self, classifications, regressions, anchors, annotations, cuda=True):
        alpha = 0.50
        gamma = 3.0
        ...
        for j in range(batch_size):
            ...
            positive_indices = torch.ge(IoU_max, 0.5) #original 0.5
...
class BBoxTransform(nn.Module):
    ...
    def __init__(self, mean=None, std=None, cuda=True):
        ...
        if self.training:
            ...
            for i in range(classification.shape[2]):
                ...
                if scores_over_thresh.sum() == 0:
                    ...
                    continue
                print(i, scores_over_thresh.sum())
                ...
                finalAnchorBoxesIndexesValue = torch.tensor([i] * len(anchors_nms_idx))
                if torch.cuda.is_available() and cuda:
            ...
            return [finalScores, finalAnchorBoxesIndexes, finalAnchorBoxesCoordinates, classification]
